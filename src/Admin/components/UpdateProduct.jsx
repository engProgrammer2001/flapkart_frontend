...
const UpdateProductForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Product data is 2: ", productData);
  };
  ...
  useEffect(() => {
    if (products.productsnew) {
      for (let key in productData) {
        setProductData((prev) => ({
          ...prev,
          [key]: products.productsnew[key],
        }));
        console.log(products.productsnew[key], "--------", key);
      }
    }
  ...
  return (
    <Fragment>
      <Typography
        variant="h3"
        sx={{ textAlign: "center" }}
        className="py-10 text-center text-blue-950"
      >
        UPDATE PRODUCT
      </Typography>
      <form
