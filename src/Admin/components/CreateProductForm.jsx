...
const CreateProductForm = () => {
  ...
  const handleChange = (e) => {
    ...
    console.log("handle Change value is ", name, value);
  ...
  return (
    <div className="lg:h-[100vh]" sx={{ backgroundColor: "red" }}>
      <Typography
        variant="h3"
        sx={{ textAlign: "center", color: "#00072D" }}
          ...
          <Grid item xs={12} sm={4}>
            <FormControl fullWidth>
              ...
              >
                ...
                {/* <MenuItem value="kids">Battery</MenuItem> */}
              </Select>
            </FormControl>
          </Grid>
          <Grid item xs={12} sm={4}>
            <FormControl fullWidth>
              ...
              >
                ...
                <MenuItem value="earphon">earphon</MenuItem>
          ...
          <Grid item xs={12} sm={4}>
            <FormControl fullWidth>
              ...
              >
                ...
                <MenuItem value="sumsung">Sumsung</MenuItem>
